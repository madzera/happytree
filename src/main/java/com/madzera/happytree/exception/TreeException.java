 ...
 * 
 * <p>The <code>TreeException</code> is the only exception (checked
 * exception) class that can be thrown inside this API. This happens when the
 * following validations do not correspond:</p>
 * 
 * <ul>
 * 	<li>When there is another session with the same identifier while initializing
 * 	a new session;</li>
 * 
 * 	<li>When the class of the object to be transformed has not been annotated with
...
public class TreeException extends Exception {
	 ...
	 * <code>null</code> detail message for the exception as well as the cause.
	 * 
	...
	/**
	 * This constructor allows specifying a detail message for the exception when
	 * it is thrown. In this case, the cause of the exception is <code>null</code>.
	 * 
	 * <p>To initialize a cause, invoke {@link #initCause(Throwable)}.</p>
	 * 
	 ...
	 * message set by the <code>message</code> parameter and <code>cause</code> as
