...
class TreeConstants {
	...
	static class Message {
		...
		//---------------------SESSION------------------
		static final String DUPLICATE_SESSION_ID = "Already existing initialized session.";
		static final String NO_DEFINED_SESSION = "No defined session.";
		static final String NO_ACTIVE_SESSION = "No active session.";
		//---------------------TREE---------------------
		static final String CUT_COPY_DETACHED_ELEMENT = "No possible to copy/cut/remove elements. Invalid lifecycle state.";
		static final String CUT_COPY_NOTFOUND_ELEMENT = "No possible to copy/cut elements. Source element not found.";
		static final String PERSIST_ATTACHED_ELEMENT = "No possible to persist the element. Invalid lifecycle state.";
		static final String UPDATE_NOT_EXISTED_ELEMENT = "No possible to update the element. Invalid lifecycle state.";
